...
function generateHTML() {
  ...
  function updateUserDataDiv() {
    ...
    dataArray.forEach((user) => {
      ...
      let last_name_div2 = document.createElement("div");
      let remove_button_div = document.createElement("div");
      const data_divs = [id_div2, first_name_div2, last_name_div2, remove_button_div];
      ...
      last_name_div2.style.textAlign = "left";
      ...
      id_div2.appendChild(id_text);
      first_name_div2.appendChild(first_name_text);
      last_name_div2.appendChild(last_name_text);
      remove_button_div.appendChild(remove_button);
      id_container.appendChild(id_div2);
      first_name_container.appendChild(first_name_div2);
      last_name_container.appendChild(last_name_div2);
